...
export const metadata: Metadata = {
  title: 'About — Senior Frontend Engineer',
  description:
    'About Kuldip Kumar Sah, a Senior Frontend Engineer working across React, TypeScript, frontend architecture, performance and complex product workflows.',
      ...
      <section className="mx-auto grid max-w-[1100px] grid-cols-[.75fr_1.25fr] gap-16 px-12 py-24 max-[800px]:grid-cols-1 max-[650px]:px-5">
        ...
        <div>
          ...
          <div className="mt-10 space-y-6 text-lg leading-8 text-[#9cafa6]">
            <p>
              I&apos;m Kuldip Kumar Sah, a Senior Frontend Engineer focused on React, TypeScript, frontend architecture
              and performance.
            </p>
            <p>
            ...
            <p>
              My experience spans fintech onboarding, proptech visualization, enterprise SaaS and restaurant operations.
              I collaborate closely with product, design and backend teams and enjoy both architecture work and detailed
