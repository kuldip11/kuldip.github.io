...
export const metadata: Metadata = {
  ...
  description:
    'Technical writing by Kuldip Kumar Sah on React architecture, performance, testing and complex frontend systems.',
        ...
        <div className="mt-16 border-t border-[#20362f]">
          {articles.map((article) => (
            <article className="border-b border-[#20362f] py-10" key={article.slug}>
              <time className="font-mono text-[10px] text-[#71f6b5]" dateTime={article.date}>
                {article.date}
              </time>
