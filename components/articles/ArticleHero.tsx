  ...
  <div className="grid gap-7 lg:grid-cols-[1fr_.9fr] lg:items-center">
    <div>
      ...
      <h1 className="mt-5 max-w-[700px] text-[clamp(2.5rem,5vw,4.8rem)] leading-[.98] font-bold tracking-[-.055em]">
        Thoughts. Learnings.
        <br />
        <span className="text-accent">Technical Deep Dives.</span>
      </h1>
    ...
    <div className="relative grid min-h-[220px] place-items-center rounded-[20px] border border-panel-border bg-[#071713]/85 p-6">
      <div className="w-full max-w-[430px] rounded-[16px] border border-[#27775a] bg-[#061612] p-6">
        <p className="text-[22px]">
          “<span className="text-accent">Better developers</span>
          <br />
          build in public.”
        </p>
        <div className="mt-8 font-mono text-[11px] text-accent">Write › Learn › Share › Grow</div>
      </div>
      <span className="absolute top-5 right-6 font-mono text-accent">
        Ideas
        <br />
        Code
        <br />
