        ...
        {RESUME_SKILL_TABS.map((item) => {
          ...
          return (
            <button
              ...
              className={`rounded-lg border px-3 py-2 text-[10px] transition-colors ${isActive ? 'border-[#59ecb0] bg-[#59ecb0] text-black' : 'border-[#27775a] hover:border-[#59ecb0] hover:text-[#59ecb0]'}`}
              key={item}
