  ...
  return (
    ...
    >
      <div className="mb-16 grid grid-cols-[1fr_1.7fr_1fr] items-end gap-10 max-[1000px]:grid-cols-[1fr_2fr] max-[650px]:grid-cols-1 max-[650px]:gap-[22px]">
        <div>
          <span className="mb-2.5 block font-mono text-[11px] text-[#087a4b]">02</span>
          <p className="m-0 font-mono text-[11px] leading-[1.4] font-semibold tracking-[.12em] text-[#526159] uppercase">
            How I engineer
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 border-t border-[#bdc8be] max-[650px]:grid-cols-1">
        {principles.map(([label, title, copy], index) => (
          <article
            ...
            key={label}
          >
            <span className="font-mono text-[10px] tracking-[.1em] text-[#087a4b]">{label}</span>
            <h3 className="mt-[50px] mb-3.5 text-[clamp(1.8rem,3vw,3.5rem)] font-medium tracking-[-.045em] max-[650px]:mt-[34px]">
              {title}
            </h3>
            <p className="max-w-[540px] leading-[1.65] text-[#526159]">{copy}</p>
          </article>
        ))}
      </div>
    </section>
